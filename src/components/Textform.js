...
export default function TextFrom(props) {
  ...
  return (
    ...
    <h2>Try TextUtils </h2>
    <textarea className="form-control" onChange={handleOnChange} style={{background:props.mode==='dark'?'grey':'white',color:props.mode === 'dark' ? 'white' : 'black'}} id="exampleFormControlTextarea1" value={text} rows="9"></textarea>
    </div>
